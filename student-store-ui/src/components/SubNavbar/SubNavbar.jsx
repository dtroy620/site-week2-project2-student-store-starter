        ...
        <nav className="sub-navbar">
            <div className="content">
                ...
                <div className="categories">
                    ...
                    <button className={selectedCategory} onClick={() => handleFilter('clothing')}>Clothing</button>
                    <button className={selectedCategory} onClick={() => handleFilter('food')}>Food</button>
                    <button className={selectedCategory} onClick={() => handleFilter('accessories')}>Accessories</button>
                    <button className={selectedCategory} onClick={() => handleFilter('tech')}>Tech</button>
                </div>
            </div>
